...
impl Image {
    pub fn new_kitty(source: &DynamicImage, id: u8, rect: Rect) -> Self {
        Image::Kitty {
            state: KittyState::TransmitAndPlace(encode_kitty(source, id)),
            unique_id: id,
            rect,
...
fn encode_kitty(img: &DynamicImage, id: u8) -> String {
